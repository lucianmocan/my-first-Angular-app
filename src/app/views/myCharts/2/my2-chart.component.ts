...
@Component({
  selector: 'app-my2-chart',
  templateUrl: './my2-chart.component.html',
  styleUrls: ['./my2-chart.component.scss']
})
export class My2ChartComponent implements OnInit {
